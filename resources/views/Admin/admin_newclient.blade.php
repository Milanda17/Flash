                              ...
                              <tr>
                                ...
                                <?php foreach ($read as $data){?>
                                  <?php if ( $data->sent=="sent"){ ?>
                                    <?php if( $data->project_name==NULL){?>

                                    <tr>
                                    <td><?php if ( $data->read<1){ ?><span class="label label-danger">New</span><?php }?></a></td>
                                     <td width="30%"><center><?php echo $data->sender ?></center></td>
                                     <td width="40%"><?php echo $data->description ?></td>
                                     <td width="10%"><a href="{{URL::to('/admin_forwad_mail',$data->Mid)}}"><button type="button" class="btn btn-success btn-sm">View</button></a></td>
