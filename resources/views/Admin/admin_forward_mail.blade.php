    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/forward_to_manager">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('to') ? ' has-error' : '' }}">
                            ...
                            <!--    <input id="to" type="email" class="form-control" name="to" value="{{ old('to') }}" required autofocus placeholder="To"> -->
                                ...
                                <select class="form-control" id="to"  name="to" required autofocus>
                                  ...
                                  <?php foreach ($manager as $mana){?>

                                      <option value="<?php echo $mana->email ?>"><?php echo $mana->email ?></option>
