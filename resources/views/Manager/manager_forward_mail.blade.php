                            ...
                            <div class="panel panel-default">
                              ...
                              <table class="table table-striped" >
                                ...
                                <?php if( $data->attachment!=NULL){?>       <tr> <center><th colspan="2"> <a href="{{URL::to('/download',$data->attachment)}} " class="btn btn-large pull-right"><i class="icon-download-alt"> </i> Download Image </a></th></tr>
                                    ...
                                    <tr><th colspan="2"> <center><button type="button" class="btn btn-success  btn-sm" data-toggle="modal" data-target="#reply">Reply</button>
...
<div class="modal fade" id="forward" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Message Forward To Manager</h4>
        </div>
        <div class="modal-body">

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/forward_to_employee">
                        {{ csrf_field() }}

                          <input id="Mid" type="hidden" class="form-control" name="Mid" value="<?php echo $data->Mid ?>" >
                        ...
                        <div class="form-group{{ $errors->has('to') ? ' has-error' : '' }}">
                            ...
                            <!--    <input id="to" type="email" class="form-control" name="to" value="{{ old('to') }}" required autofocus placeholder="To"> -->
                                ...
                                <select class="form-control" id="to"  name="to" required autofocus>



                                      <option value="<?php echo $data->employee_email1 ?>"><?php echo $data->employee_email1 ?></option>
                                        <option value="<?php echo $data->employee_email2 ?>"><?php echo $data->employee_email2 ?></option>
                                          <option value="<?php echo $data->employee_email3 ?>"><?php echo $data->employee_email3 ?></option>
                                            <option value="<?php echo $data->employee_email4 ?>"><?php echo $data->employee_email4 ?></option>
                                              <option value="<?php echo $data->employee_email5 ?>"><?php echo $data->employee_email5 ?></option>
