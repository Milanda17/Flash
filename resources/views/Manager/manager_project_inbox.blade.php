                             ...
                             <tr>
                               ...
                               <?php foreach ($read as $data){?>
                                  ...
                                  <?php if ( $data->manager_email==Auth::user()->email){?>
                                   ...
                                   <tr>
                                    <td><?php if ( $data->read!="read" || $data->read<2){ ?><span class="label label-danger">New</span><?php }?></a></td>
                                    <td width="30%"><center><?php echo $data->sender ?></center></td>
                                    <td width="40%"><center></center><?php echo $data->description ?></td>
                                    <td width="10%"><a href="{{URL::to('/manager_forwad_mail',$data->Mid)}}"><button type="button" class="btn btn-success btn-sm">View</button></a></td>
