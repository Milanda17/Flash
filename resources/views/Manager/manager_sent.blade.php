                                ...
                                <?php foreach ($read as $data){?>
                                  ...
                                  <?php if ( $data->recever==Auth::user()->email){ ?>
                                      ...
                                      <tr>
                                       ...
                                       <td width="40%"><center><?php echo $data->description ?></center></td>
                                       <td width="10%"><a href="{{URL::to('/one_mail_sent',$data->Mid)}}"><button type="button" class="btn btn-success btn-sm">View</button></a></td>
