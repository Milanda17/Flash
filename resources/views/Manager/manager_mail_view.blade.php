                            ...
                            <div class="panel panel-default">
                              ...
                              <table class="table table-striped" >
                                ...
                                <?php foreach ($read as $data){?>
                                  ...
                                  <?php if( $data->attachment!=NULL){?>    <tr><th colspan="2"><img src="/images/{{$data->attachment}}"></th></tr> <?php }?>
...
<div class="modal fade" id="forward" role="dialog">
  ...
  <input id="description" type="hidden" class="form-control" name="description" value="<?php echo $data->description ?>" required placeholder="Subject">
